...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var x$3 = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(x$3, references);
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$getColor$1__I__T = (function(remainingChars) {
  switch (remainingChars) {
    default: {
      return ((remainingChars > 14) ? "green" : ((remainingChars >= 0) ? "orange" : "red"))
    }
  }
});
